...
namespace EmployeeManagment.Migrations
{
    ...
    [Migration("20200306122940_ManytomanyofEmployment")]
    partial class ManytomanyofEmployment
    {
            ...
            modelBuilder.Entity("EmployeeManagment.models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AdmissionType = 1,
                            AdmissionYear = 0,
                            DateOfBirth = new DateTime(2020, 3, 6, 4, 29, 38, 624, DateTimeKind.Local).AddTicks(9998),
